...
const Navbar = () => {
  return (
    <nav className="navbar">
      <center>
        <h2 className="logo" style={{ position: "relative" }}>Courier Tracking</h2>
      </center>
      <ul className="nav-links">
        ...
        <li><Link to="/status1" style={{ color: "black", textDecoration: "none", backgroundColor: "white" }}>Status1</Link></li>
      </ul>
    </nav>
  )
}
